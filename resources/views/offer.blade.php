                                            ...
                                            <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                                <div class="wp-block-image">
                                                    <figure class="aligncenter size-large">
                                                        <img src="{{ $service->photo }}" alt="{{ $service->name }}" class="wp-image"/>
                                                    </figure>
                                                </div>
                                                <h2 class="has-text-align-left wp-block-heading">{{ $service->name }}</h2>
                                                <p class="has-small-font-size">{{ $service->description }}</p>
                                                <p class="has-small-font-size">Fecha de inicio: {{ $service->date_one }}</p>
                                                <p class="has-small-font-size">Fecha de finalización: {{ $service->date_two }}</p>
                                                <p class="has-small-font-size">Descuento: {{ $service->discount_percentage }}%</p>
                                                <p class="has-small-font-size">Razón: {{ $service->reason }}</p>
                                            </div>
                                        @endif
                                    @endforeach
                                </div>
