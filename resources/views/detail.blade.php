...
<html lang="en">
    <head>
        ...
        <link rel="alternate" type="application/rss+xml" title="Merrash &raquo; Feed" href="{{ route('welcome') }}"/>
        <link rel="alternate" type="application/rss+xml" title="Merrash &raquo; Comments Feed" href="{{ route('welcome') }}"/>
                    ...
                    <div class="main-menu-container">
                        <ul id="menu-primary-menu" class="main-menu" aria-label="submenu">
                            ...
                            <li id="menu-item-17" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-6 current_page_item menu-item-17">
                                <a href="{{ route('services.available') }}" aria-current="page">Services</a>
                            </li>
                ...
                <section id="primary" class="content-area">
                    <main id="main" class="site-main">
                        <article id="post-6" class="post-6 page type-page status-publish hentry entry">
                            <header class="entry-header responsive-max-width" style="margin-left: 15px; margin-right: 15px;">
                                <h1 class="entry-title">Detalles de {{ $service->name }}</h1>
                            </header>
                            <div class="entry-content" style="margin-left: 15px; margin-right: 15px">
                                ...
                                <h3 class="has-text-align-left wp-block-heading">Detalles del Servicio</h3>
                                <ul class="has-small-font-size">
                                    <li><strong>Función: </strong>{{ $service->function }}</li>
                                    <li><strong>Complementos: </strong>{{ $service->complement }}</li>
                                    <li><strong>Efectos: </strong>{{ $service->effects }}</li>
                                    <li><strong>Proceso: </strong>{{ $service->procces }}</li>
                                    <li><strong>Meta: </strong>{{ $service->goal }}</li>
                                    <li><strong>Duración: </strong>{{ $service->duration }}</li>
                                </ul>
                                <div style="display: flex; justify-content: center; margin-top: 20px;">
                                    <a href="https://api.whatsapp.com/send?phone=7224958550&amp;text=Me%20gustaría%20saber%20más%20sobre%20{{ $service->name }}" class="button" style="display: flex; align-items: center; background-color:#59bb40; color: white;">
                                ...
                                <div style="display: flex; justify-content: center; margin-top: 20px;">
                                    <a class="wp-block-button__link" style="flex: display; align-items: center;" href="{{ route('services.available') }}">Servicios</a>
                                </div>
                                <div style="height:32px" aria-hidden="true" class="wp-block-spacer desktop-only"></div>
                                <hr class="wp-block-separator is-style-wide"/>
                            </div>
