...
<html lang="en">
    <head>
        ...
        <link rel="alternate" type="application/rss+xml" title="Site Title &raquo; Feed" href="https://radial51.wordpress.com/feed/"/>
        <link rel="alternate" type="application/rss+xml" title="Site Title &raquo; Comments Feed" href="https://radial51.wordpress.com/comments/feed/"/>
        ...
        <style id='jetpack-global-styles-frontend-style-inline-css'>
            ...
            body {
    background-image: url('img/brand/Doc1.png');
    background-size: cover; /* Ajusta la imagen para cubrir todo el área del body */
    background-position: left top; /* Posiciona la imagen a la izquierda arriba */
    background-repeat: no-repeat; /* Evita que la imagen se repita */
    background-attachment: fixed; /* Mantiene la imagen fija durante el desplazamiento */
    background-color: #fbfbfb; /* Color de fondo de respaldo */
}
        ...
        <meta property="og:description" content="Let&#8217;s talk 👋 Don&#8217;t hesitate to reach out with the contact information below, or send a message using the form. Get in Touch 10 Street RoadCity, 10100USA mail@example.com (555) 555 1234 …"/>
        ...
        <meta name="description" content="Let&#039;s talk 👋 Don&#039;t hesitate to reach out with the contact information below, or send a message using the form. Get in Touch 10 Street RoadCity, 10100USA mail@example.com (555) 555 1234 Open Hours Send Us a Message"/>
    </head>
    <body style="margin-top: -40px;" class="page-template-default page page-id-7 logged-in admin-bar no-customize-support wp-embed-responsive customizer-styles-applied singular image-filters-enabled hide-homepage-title mobile-nav-side jetpack-reblog-enabled has-launch-banner">
        <script type="text/javascript">
            function hideBubble() {
                    ...
                    <main id="main" class="site-main">
                        <article id="post-7" class="post-7 page type-page status-publish hentry entry">
                            <div class="entry-content">
                                ...
                                <div style="background-color: #82638c; padding: 15px; border-radius: 40px; width: 500px; float: right; margin-left: 200vw;">
                                    <h3 class="has-text-align-left wp-block-heading" style="color: #121212; text-align: center;">Merrash</h3>
                                    <p style="text-align: center; color: #121212;">
                                        Estás a un paso de permitirnos mejorar tu vida con Merrash. Déjanos tus datos y en breve nos pondremos en contacto contigo.
                                    </p>
                                    <div data-test='contact-form' id='contact-form-7' class='wp-block-jetpack-contact-form-container'>
                                        <form id='contact-form' method='post' class='contact-form commentsblock' aria-label="Contact" novalidate onsubmit="sendToWhatsApp(event)">
                                            <center>
                                            <div class='grunion-field-name-wrap grunion-field-wrap'>
                                                <label for='g7-name' class='grunion-field-label name'>
                                                    Nombre<span class="grunion-label-required" aria-hidden="true">(requerido)</span>
                                                </label>
                                                <input type='text' name='g7-name' id='g7-name' value='' style='width: 300px;' class='name grunion-field' required aria-required='true'/>
                                            </div>
                                            <center/>
                                            ...
                                            <div class='grunion-field-email-wrap grunion-field-wrap'>
                                                <label for='g7-email' class='grunion-field-label email'>
                                                    Email<span class="grunion-label-required" aria-hidden="true">(requerido)</span>
                                                </label>
                                                <input type='email' name='g7-email' id='g7-email' value='' style='width: 300px;' class='email grunion-field' required aria-required='true'/>
                                            </div>
                                            <center/>
                                            ...
                                            <div class='grunion-field-phone-wrap grunion-field-wrap'>
                                                <label for='g7-phone' class='grunion-field-label phone'>
                                                    Teléfono<span class="grunion-label-required" aria-hidden="true">(requerido)</span>
                                                </label>
                                                <input type='text' name='g7-phone' id='g7-phone' value='' style='width: 300px;' class='phone grunion-field' required aria-required='true'/>
                                            </div>
                                            <center/>

                                            <center>
                                            <div class='grunion-field-textarea-wrap grunion-field-wrap'>
                                                <label for='contact-form-comment-g7-message' class='grunion-field-label textarea'>
                                                    Servicio<span class="grunion-label-required" aria-hidden="true">(requerido)</span>
                                                </label>
                                                <textarea name='g7-message' id='contact-form-comment-g7-message' rows='10' class='textarea grunion-field' required aria-required='true'></textarea>
                                            </div>
                                            <center/>
                ...
                <section class="page-section" id="contact">
                    <div class="container">
                        <div class="text-center">
                            <center>
                            <h2 class="section-heading text-uppercase" style="color: #121212;">Ubicación</h2>
                        </center>
                            <center>
                            <h3 class="section-subheading text-muted" style="color: #121212;">Te dejamos la ubicación de nuestra sucursal.</h3>
                            <br>
                        </center>
                        </div>
                        <!-- Mapa de Google -->
                        <div class="col-md-12">
                            <div class="form-group form-group-textarea mb-md-0">
                                <center>
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3762.299543739984!2d-99.59152579999999!3d19.250600100000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85cd8b3e17bedddb%3A0x54244cd203fcd220!2sMerrash%20y%20spa%20integral%20de%20belleza!5e0!3m2!1sen!2smx!4v1674004993379!5m2!1sen!2smx" width="800" height="600" style="border: 5px solid black; border-radius: 10px; margin-bottom: 70px; width: 80vw; height: 60vh;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </center>
                            </div>
                        </div>
                    </div>
        ...
        <style id='jetpack-block-business-hours-inline-css'>
            @media(min-width: 600px) {
                .jetpack-business-hours dd,.jetpack-business-hours dt {
            ...
            .jetpack-business-hours dt {
                font-weight: 700;
                margin-inline-end:.5em;min-width: 30%;
                vertical-align: top
            }
        ...
        <link crossorigin='anonymous' rel='stylesheet' id='all-css-2-2' href='https://s0.wp.com/wp-content/mu-plugins/jetpack-plugin/moon/jetpack_vendor/automattic/jetpack-forms/dist/contact-form/css/grunion.css?m=1715858256i&cssminify=yes' type='text/css' media='all'/>
        ...
        <script crossorigin='anonymous' type='text/javascript' src='https://s0.wp.com/_static/??-'></script>
        ...
        <script crossorigin='anonymous' type='text/javascript' src='https://s0.wp.com/_static/??-eJy1jUEOgjAQRS8kflgIcWE8iinDaFraTsNM4foqUW/g8r/8vIetNCTZOBtSbUqsD58Vga04mj8bSSR/2W3lPMkCV02SM/P0e99lSYrJq2GMQrNi9bwdgx7wp8zb6ch2hKBwRKzqx8g7eqWv6dIN7alvh3PfhScwEVoj'></script>
        <script>
